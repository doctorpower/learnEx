...
class App extends Component {
    ...
    info = [
        ...
        },
        {
            ...
            result: 'Результатом является знание, которое будет проверено тестированием',
        },
        {
            title: 'React.js',
            time: '8 часов',
            ...
            result: 'Результатом является тестовое приложение, о котором вам расскажет лид',
        },
        {
            title: 'Redux',
            time: '4 часа',
        ...
        },
        {
            ...
            result: 'Результатом является добавление bootstrap к вашему приложению',
        },
        {
            title: 'Node.js',
            time: '8 часов',
